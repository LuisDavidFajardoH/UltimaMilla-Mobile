...
const EntregaConfirmada = () => {
    ...
    return (
        <View style={styles.container}>
            <LottieView
                source={require('./animations/success_animation.json')} // Adjust path to your Lottie JSON file
                autoPlay
                loop={false}
                style={styles.lottie}
            />
            <Text style={styles.titulosE}>Entrega Exitosa</Text>
            <Text style={styles.subTituloFinal}>¡Gracias por tu trabajo!</Text>
            <TouchableOpacity style={styles.button} onPress={handleDetailsClick}>
                <Text style={styles.buttonText}>Volver al tablero</Text>
            </TouchableOpacity>
        </View>
    );
};
...
export default EntregaConfirmada;
